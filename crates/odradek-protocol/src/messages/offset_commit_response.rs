...
impl OffsetCommitResponse {
    ...
    /// Decode one `OffsetCommitResponse`, bounding allocation by the default
    ...
    /// Decode one `OffsetCommitResponse` under `limits`.
    ...
    /// Decode one `OffsetCommitResponse` against an existing `budget`.
            ...
            match len {
                ...
                Some(n) => {
                    ...
                    for _ in 0..n {
                        ...
                        let item =
                            OffsetCommitResponseTopic::decode_with_budget(buf, version, budget)?;
...
impl crate::Message for OffsetCommitResponse {
    ...
    fn decode_with_limits(
        ...
        OffsetCommitResponse::decode_with_limits(buf, version, limits)
    }
}
...
impl OffsetCommitResponseTopic {
    ...
    /// Decode one `OffsetCommitResponseTopic`, bounding allocation by the default
    /// [`Limits`] derived from `buf`'s remaining length.
    pub fn decode(buf: &mut impl Buf, version: i16) -> Result<Self, DecodeError> {
        Self::decode_with_limits(buf, version, Limits::default())
    }

    /// Decode one `OffsetCommitResponseTopic` under `limits`.
    pub fn decode_with_limits(
        buf: &mut impl Buf,
        version: i16,
        limits: Limits,
    ...
    /// Decode one `OffsetCommitResponseTopic` against an existing `budget`.
    pub fn decode_with_budget(
        buf: &mut impl Buf,
        version: i16,
        budget: &mut Budget,
        ...
        this.partitions = {
            ...
            match len {
                ...
                Some(n) => {
                    ...
                    for _ in 0..n {
                        let mark = buf.remaining();
                        let item = OffsetCommitResponsePartition::decode_with_budget(
                            buf, version, budget,
                        )?;
                        budget.progress(mark, buf.remaining())?;
                        budget.push(&mut items, item)?;
...
impl OffsetCommitResponsePartition {
    ...
    /// Decode one `OffsetCommitResponsePartition`, bounding allocation by the default
    /// [`Limits`] derived from `buf`'s remaining length.
    pub fn decode(buf: &mut impl Buf, version: i16) -> Result<Self, DecodeError> {
        Self::decode_with_limits(buf, version, Limits::default())
    }

    /// Decode one `OffsetCommitResponsePartition` under `limits`.
    pub fn decode_with_limits(
        buf: &mut impl Buf,
        version: i16,
        limits: Limits,
    ...
    /// Decode one `OffsetCommitResponsePartition` against an existing `budget`.
    pub fn decode_with_budget(
        buf: &mut impl Buf,
        version: i16,
        budget: &mut Budget,
