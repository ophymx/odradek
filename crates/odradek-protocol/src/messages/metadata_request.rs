...
impl MetadataRequest {
    ...
    /// Encode this `MetadataRequest` at `version`.
    ...
    /// Decode one `MetadataRequest`, bounding allocation by the default
    ...
    /// Decode one `MetadataRequest` under `limits`.
    ...
    /// Decode one `MetadataRequest` against an existing `budget`.
            ...
            match len {
                ...
                Some(n) => {
                    ...
                    for _ in 0..n {
                        ...
                        let item = MetadataRequestTopic::decode_with_budget(buf, version, budget)?;
...
impl crate::Message for MetadataRequest {
    ...
    fn decode_with_limits(
        ...
        MetadataRequest::decode_with_limits(buf, version, limits)
    }
}
...
impl MetadataRequestTopic {
    /// Encode this `MetadataRequestTopic` at `version`.
    pub fn encode(&self, buf: &mut impl BufMut, version: i16) -> Result<(), EncodeError> {
        if version >= 10 {
    ...
    /// Decode one `MetadataRequestTopic`, bounding allocation by the default
    /// [`Limits`] derived from `buf`'s remaining length.
    pub fn decode(buf: &mut impl Buf, version: i16) -> Result<Self, DecodeError> {
        Self::decode_with_limits(buf, version, Limits::default())
    }

    /// Decode one `MetadataRequestTopic` under `limits`.
    pub fn decode_with_limits(
        buf: &mut impl Buf,
        version: i16,
        limits: Limits,
    ...
    /// Decode one `MetadataRequestTopic` against an existing `budget`.
    pub fn decode_with_budget(
        buf: &mut impl Buf,
        version: i16,
        budget: &mut Budget,
