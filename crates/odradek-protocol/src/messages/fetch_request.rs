...
//! `unknown_tagged_fields`): FetchRequest.ClusterId (tag 0), FetchRequest.ReplicaState (tag 1), FetchPartition.ReplicaDirectoryId (tag 0), FetchPartition.HighWatermark (tag 1).
